...
```
# Dashboard
When the robot is locked at protective stop, urdashboard allows unlock it. 
This module was written by [Byeongdu Lee](https://github.com/Byeongdulee).
...
# Additional Note for the version by B. Lee
primary.py is added. This does not use threading. Just read once whenever requested.
urmon_parser.py is added. The parser was originally at ursecmon.py, but get independent to be used for both primary and secondary client. New parser is added for firmware (5.8) and higher. Renamed RobotModeData according to the excel sheet; isRobotConnected, isPowerOnRobot, isSecurityStopped are changed to isRealRobotConnected, isRobotPowerOn, and isProtectiveStopped, respectively.
